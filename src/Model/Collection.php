...
class Collection extends Model
{
    ...
    protected $attributes = [
        'collect_from' => null, //OPTIONAL: The name of the recipient to deliver to. This can be a person’s name e.g. John Tan, a company’s name e.g. ABC Inc., or both e.g. John Tan (ABC Inc.)
        'collection_time' => null, //OPTIONAL: The delivery time window. This will be displayed in the job list view and the delivery detail view on the app.
        'status' => null,
        'open_job' => null,
        'offer' => null,
